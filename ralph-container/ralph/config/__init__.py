...
class LangchainConfig(BaseModel):
    ...
    model_provider: Literal["azure_openai", "github", "google_genai", "ollama"] = Field(default="google_genai", description="Provider for the model: 'azure', 'github', 'google_genai' or 'ollama'")
